package com.example.newfood.fragment.bottomsheet
...
import com.example.newfood.databinding.FragmentMealBottomSheetBinding
...
//            Glide.with(this).load(meal.strMealThumb).into(binding.imgBottomSheet)
                Glide.with(requireContext()).load(meal.strMealThumb).into(binding.imgBottomSheet)
